...
ACTIONS = (
    ...
    Action("find", "sc_section_note", "sc_find", ("Ctrl+F",)),
    Action("replace", "sc_section_note", "sc_replace", ("Ctrl+H",)),
    Action("find_next", "sc_section_note", "sc_find_next", ("F3",)),
    Action("find_previous", "sc_section_note", "sc_find_previous", ("Shift+F3",)),
    ...
    Action("bold", "sc_section_format", "sc_bold", ("Ctrl+B",)),
    Action("italic", "sc_section_format", "sc_italic", ("Ctrl+I",)),
    Action("strike", "sc_section_format", "sc_strike", ("Ctrl+Shift+X",)),
    Action("code", "sc_section_format", "sc_code", ("Ctrl+E",)),
    Action("heading1", "sc_section_format", "sc_heading1", ("Ctrl+1",)),
    Action("heading2", "sc_section_format", "sc_heading2", ("Ctrl+2",)),
    Action("heading3", "sc_section_format", "sc_heading3", ("Ctrl+3",)),
    Action("quote", "sc_section_format", "sc_quote", ("Ctrl+Q",)),
    Action("bullet", "sc_section_format", "sc_bullet", ("Ctrl+Shift+L",)),
